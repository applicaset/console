...
kubectl config set-context applicaset-oidc@applicaset-nbg1 --cluster=applicaset-nbg1 --user=applicaset-oidc
kubectl config use-context applicaset-oidc@applicaset-nbg1`;
    },
    columns() {
      return [
        {
